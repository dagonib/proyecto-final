   		...
   		<div class="row">
   			<div class="col-md-12 mb-5">
				<h1>${workshop.title}</h1>
   				 ...
   				 <form:form action="saveenroll" modelAttribute="enroll" method="post">
   				 
<!-- 					<div class="input-group mb-3"> -->
<!-- 						  <div class="input-group-prepend"> -->
<!-- 						   	 	<span class="input-group-text" id="basic-addon1">Taller</span> -->
<!-- 						  </div> -->
<%-- 						  <form:input type="number" path="workshop.idworkshop" value="${workshop.idworkshop}"  placeholder="${workshop.title}" class="form-control" aria-label="Taller" aria-describedby="basic-addon1" /> --%>
<!-- 					</div> -->
					
					<form:input type="hidden" path="workshop.idworkshop" value="${workshop.idworkshop}" />
					...
					<div class="input-group mb-3">
						  ...
						  <form:input type="text" path="address" class="form-control" placeholder="Dirección" aria-label="Dirección" aria-describedby="basic-addon1" />
					</div>
	  		...
	  		<div class="row">
	  			<div class="col-md-4 mb-5">
		        	<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath }/">Volver &raquo;</a>
	  			</div>
	  		</div>
  </div>
