				    ...
				    <div class="container h-100">
					      <div class="row h-100 align-items-center">
					        <div class="col-lg-12">
					          ...
					          <p class="lead mb-5 text-white-50"> Administración de inscritos </p>
					        </div>
					      </div>
   		...
   		<div class="row">
   			<div class="col-md-12 mb-5">
					...
					<c:forEach var="enroll" items="${enrolls }">
							...
							<c:url var="linkEditar" value="/secretario/updateenroll">
								<c:param name="idenroll" value="${enroll.idenroll}" />
							</c:url>
						
							<c:url var="linkBorrar" value="/admin/deleteenroll">
								<c:param name="idenroll" value="${enroll.idenroll}" />
							</c:url>
						

						<tr>
							<td>${enroll.idenroll}</td>
							<td>${enroll.name}</td>	
  		...
  		<sec:authorize access="hasAnyRole('ADMIN','SECRETARIO')">
	  		<div class="row">
	  			<div class="col-md-4 mb-5">
		        	<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath }/talleres">Volver &raquo;</a>
	  			</div>
	  		</div>
  		</sec:authorize>
  </div>
