   		...
   		<div class="row">
   			<div class="col-md-12 mb-5">
				<h1>${workshop.title}</h1>
   				 ...
   				 <form:form action="saveenrollupdate" modelAttribute="enroll" method="post">
					<form:hidden path="idenroll" />
					...
					<div class="input-group mb-3">
   				 	...
   				 	<form:input type="hidden" path="workshop.idworkshop" />
	  		...
	  		<div class="row">
	  			<div class="col-md-4 mb-5">
		        	<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath }/inscritos">Volver &raquo;</a>
	  			</div>
	  		</div>
  </div>
